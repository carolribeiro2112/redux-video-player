...
describe('player slice', () => {
  it('should be able to play', () => {
    const state = reducer(stateMock, play([1,2]))
  ...
  it('should be able to play next video automatically', () => {
    const state = reducer(stateMock, next())
  ...
  it('should be able to jump to next module automatically', () => {
    const state = reducer( {...stateMock, currentLessonIndex: 1}, next())
  ...
  it('should not update the current module and lesson index if there is no next lesson available', () => {
    const state = reducer( {...stateMock, currentLessonIndex: 1, currentModuleIndex: 1}, next())
